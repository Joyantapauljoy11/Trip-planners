...
const Destination = () => {
  ...
  useEffect(() => {
    fetch("https://rocky-temple-37411.herokuapp.com/destinations")
      .then((res) => res.json())
  ...
  return (
    <div className="container my-4">
      <div className="py-4">
        <h3 className="text-danger" style={{ fontFamily: "'Rubik', sans-serif", fontSize: "36px" }}>Popular Destination</h3>
        <p>
